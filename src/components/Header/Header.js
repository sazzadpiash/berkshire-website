...
const Header = () => {
    return (
        <header>
            <div className="top-header px-4 py-3 flex justify-between items-center">
                <div className="logo">
                ...
                <div className="searchbar w-1/2">
                    <div className="form-control">
                        <div className="input-group">
                            <input type="text" id='searchBar' placeholder="Search…" className="input px-3 h-10 input-bordered w-full !rounded-none" />
                            <button className="btn btn-primary text-white !rounded-none btn-sm h-[40px]">
