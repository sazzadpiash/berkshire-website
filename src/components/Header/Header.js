        ...
        <header>
                    ...
                    <div className="form-control">
                        <div className="input-group">
                            <form className='w-full relative'>
                                <input type="text" id='searchBar' onChange={searchOnChange} placeholder="Search…" className="searchInput input px-3 h-10 input-bordered w-full focus:outline-0 focus:border-primary" />
            ...
            <div className="bottom-header border-t border-b border-gray-200 text-black py-2 relative">
                <ul className='flex justify-start gap-10 max-w-7xl mx-auto'>
                    ...
                    <Link to='/furniture/room/468'><li>Product Type</li></Link>
