...
const Header = () => {
    ...
    return (
        <>
            ...
            <nav className="relative px-4 py-4 flex justify-between items-center bg-white lg:hidden">
                <Link to="/">
            ...
            <div className={`navbar-menu lg:hidden relative z-50 ${isMenuOpen ? "" : "hidden"}`}>
