...
const BulkEdit = () => {
    ...
    return (
        <div>
            ...
            {productCount}
            <div className='max-w-6xl mt-10 mx-auto overflow-hidden h-screen'>
                <div className="overflow-auto h-5/6 rounded-lg border">
                        ...
                        <tbody>
                            {
                                allProducts.map((singleProduct, i) =>
                                    <tr key={singleProduct._id}>
                                        ...
                                        <th className='border-r overflow-hidden'>{singleProduct.name}</th>
